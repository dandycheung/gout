...
func TestReqModifyUrl(t *testing.T) {
	src := []string{"127.0.0.1", ":8080/query", "/query", "http://127.0.0.1", "https://127.0.0.1", "HTTP://127.0.0.1", "HTTPS://127.0.0.1", "HtTp://example.com", "HtTpS://example.com"}
	want := []string{"http://127.0.0.1", "http://127.0.0.1:8080/query", "http://127.0.0.1/query", "http://127.0.0.1", "https://127.0.0.1", "HTTP://127.0.0.1", "HTTPS://127.0.0.1", "HtTp://example.com", "HtTpS://example.com"}
